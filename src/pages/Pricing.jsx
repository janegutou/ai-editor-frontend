  ...
  return (
    <div className="bg-gray-50 py-12 px-4">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className=" text-gray-600 text-lg mt-4 mb-8">Recharge with tokens and consume as needed. Simple and efficient!</p>
        ...
        <div className="mt-16 max-w-3xl mx-auto text-left">
            ...
            <ul className="mt-4 space-y-4 text-gray-600">
                <li><strong>How to use tokens?</strong> Each token represents a unit of usage. You can use tokens for AI generating content. Tokens are deducted as you use the service.</li>
                <li><strong>When do I receive the tokens after recharge?</strong> Tokens are added immediately after you complete your payment.</li>
                <li><strong>Can I get a refund for unused tokens?</strong> Tokens are non-refundable once recharged, so please ensure you only recharge the amount you need.</li>
                <li><strong>What happens if I run out of tokens?</strong> You can top-up anytime by purchasing more tokens.</li>
                <li><strong>Is there a limit to how many tokens I can recharge?</strong> There is no limit; you can recharge as many times as you want based on your usage.</li>
                <li><strong>How many tokens does the free trial include?</strong> After signing up, you will receive 100 free tokens to experience our service.</li>
        </ul>
        </div>
      </div>
    </div>
